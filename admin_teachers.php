...
<body>
    ...
    <!-- Start admin Profiel 
    ============================================= -->
    <div class="teachers-profiel adviros-details-area default-padding">
        <div class="container">
            <div class="row d-flex justify-content-between">
                <div class="col-md-10" style="padding-bottom:30px;">
                    <h2 style="font-weight:600">Manage Teachers</h2>
                    <p><a href="admin_home.php">Home</a> / Manage Teachers</p>
                </div>
                <div class="col-md-2" style="text-align:right; padding-right:70px; padding-top:20px;">
                    <a href="admin_teacher_add.php" class="btn btn-success">Add Teachers</a>
                </div>
            </div>
            <div class="row">
                <table class="table" style="font-size: 14px;color:#222;">
                    ...
                    ?>
                        <tr>
                            <td><img src="./assets/img/teachers/<?php echo $image?>"
                            ...
                            <td><a href="admin_teacher_delete.php?id=<?php echo $id ?>"

...
<body>
    ...
    <div class="popular-courses default-padding bottom-less without-carousel">
        <div class="container">
            <div class="row">
            <div class="text-left col-md-8" style="margin-bottom:50px">
                    <h2 style="font-weight:600">My Courses</h2>
                    <p><a href="student_home.php">Home</a> / My Courses</p>
                </div>
            </div>
            <div class="row">
                <div class="popular-courses-items bottom-price">
                    <?php 
                                $sql22 = "SELECT * FROM course_student where student_id =$student_id order by sl desc";

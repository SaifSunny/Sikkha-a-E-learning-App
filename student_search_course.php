                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="popular-courses-items bottom-price">
                                <?php 
                                $sql = "SELECT * FROM courses where category_id =$search_id";
                                $result = mysqli_query($conn, $sql);
                                if($result){
                        ...
                        <aside>
                            ...
                            <div class="sidebar-item category">
                                ...
                                <div class="sidebar-info">
                                    ...
                                    ?>
                                        <li>
                                        <a href="student_search_course.php?category_id=<?php echo $id?>"><?php echo $category_name?><span><?php echo $row_cnt?> </span></a>

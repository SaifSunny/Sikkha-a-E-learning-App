            ...
            if(!$query_run->num_rows > 0){
                ...
                if( in_array($imageFileType,$extensions_arr) ){
                    ...
                    if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
                        ...
                        // Convert to base64 
                        $image_base64 = base64_encode(file_get_contents('assets/img/teachers/'.$name));
        ...
        <div class="container">
            <div class="row d-flex justify-content-between">
                <div class="col-md-10" style="padding-bottom:30px;">
                    <h2 style="font-weight:600">Add Teacher</h2>
                    <p><a href="admin_home.php">Home</a> / <a href="admin_teachers.php">Manage Teachers</a> / Add Teacher
                    </p>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="info title">
                                    <form action="" method="POST" enctype='multipart/form-data'>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div>
                                                    <img src="assets/img/teachers/user.png" alt="Thumb" width="80%">
                                                </div>

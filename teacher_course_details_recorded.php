...
if (isset($_POST['submit_lesson'])) {
    ...
    $query = "SELECT * FROM course_lessons WHERE lesson_title = '$lesson_title' AND lesson_video = '$lesson_video'";
    $query_run = mysqli_query($conn, $query);
    if (!$query_run->num_rows > 0) {

        // Update Record
        $query2 = "INSERT INTO course_lessons (course_id, lesson_no, lesson_title, lesson_description, lesson_video) 
        VALUES ('$course_id', '$lesson_no', '$lesson_title', '$lesson_description', '$lesson_video')";
        $query_run2 = mysqli_query($conn, $query2);
        
        if ($query_run2) {
            $cls="success";
            $error = "Course Lesson Successfully Added.";
        } 
        else {
            $cls="danger";
            $error = mysqli_error($conn);
                                                        ...
                                                        <div class="panel-body">
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="item ">
                                                                    <a href="teacher_lesson_data.php?id=<?php echo $lesson_id?>&cid=<?php echo $course_id?>"
                                                                            class="btn btn-success"
                                                                            style="padding:5px 2px 2px 8px;">View Attempts</a>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-12"
                                                                            ...
                                                                            <label for=""
                                                                                ...
                                                                                Video Link</label>
                                                                            <input type="text" class="form-control"
                                                                                name="lesson_video" placeholder="Enter Lesson
                                                                                Video Link" style="color:black;">
                                                                        </div>
                                                                        <div class="col-md-12"
                                                                            style="padding-top:30px;">
                                                                            <label for=""
                                                        ...
                                                        <div class="panel-body">
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="item title" style="padding-top:5px;">
                                                                        <h5>Duration: <?php echo $exam_duration?> Minutes</h5>
                                                                    </div>
                                                                    <div class="item ">
                                                                    <a href="teacher_exam_submission.php?id=<?php echo $exam_id?>&cid=<?php echo $course_id?>"
                                                                            class="btn btn-success"
                                                                            style="padding:5px 2px 2px 8px;">View Submissions</a>
                                                            ...
                                                            <div class="item" style="margin-top:20px">
                                                                ...
                                                                <form action="" method="post">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <label for=""
                                                                                style="padding-bottom:10px;color:black;font-weight:600;">Lesson No.</label>
                                                                            <select class="form-control" name="lesson_id"
                                                                                ...
                                                                                <option
                                                                                    ...
                                                                                    Lesson: <?php echo $row2['lesson_no']." (".$row2['lesson_title'].")"?>
                                                                                </option>
                                                                                <?php
                                                                                    }
                                                                                }

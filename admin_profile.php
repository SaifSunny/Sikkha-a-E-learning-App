    ...
    if (in_array($imageFileType, $extensions_arr)) {
        ...
        if (
            ...
            $image_base64 = base64_encode(
                file_get_contents("assets/img/admin/" . $name)
            );
            $image =
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12" style="padding-bottom:30px;">
                    <h2 style="font-weight:600">Admin Profile</h2>
                    <p><a href="admin_home.php">Home</a> / Admin Profile</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-5 thumb">
                    <img src="assets/img/admin/<?php echo $image?>" alt="Thumb" width="90%">

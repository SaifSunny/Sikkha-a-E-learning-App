...
if (isset($_POST['submit'])) {
    ...
    $cls="";
        ...
        VALUES ('$topic', '$description', '$post_date', '$teacher_id', 'Teacher')";
        ...
        <div class="container">
            <div class="row">
                <div class="text-left col-md-8">
                    <h2 style="font-weight:600">My Posts</h2>
                    <p><a href="teacher_home.php">Home</a> / My Posts</p>
                </div>
                        ...
                        <div class="single-item">
                            <div class="item" style="">
                                ...
                                <div class="info"
                                    ...
                                    <?php 
                                        $sql = "SELECT * FROM posts where sender_id =$teacher_id and role = 'Teacher' ORDER BY post_id DESC";
                                        $result = mysqli_query($conn, $sql);
                                        if($result){
                                    ...
                                    <div>
                                        ...
                                        <div class="row" style="padding-bottom:20px;">
                                            <div class="col-md-11">
                                                <h3>
                                                    <a
                                                        href="teacher_post_details.php?id=<?php echo $id?>"><?php echo $topic?></a>
                                                </h3>
                                            </div>
                                            <?php

                                                   if($sender_id==$teacher_id && $role=="Teacher"){
                                                ?>
                                            <div class="col-md-1">
                                                <a href="teacher_post_delete.php?id=<?php echo $id?>"

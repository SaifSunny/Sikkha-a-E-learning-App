    ...
    if (in_array($imageFileType, $extensions_arr)) {
        ...
        if (
            ...
            $image_base64 = base64_encode(
                file_get_contents("assets/img/students/" . $name)
            );
            $image =
                "data:image/" . $imageFileType . ";base64," . $image_base64;

            // Update Record
            $query2 = "UPDATE students SET `student_img`='$name' WHERE username='$username'";
...
if (isset($_POST["submit"])) {
    ...
    // Update Record
    $query2 = "UPDATE students SET firstname='$firstname',lastname='$lastname',
    ...
    if ($pass == $old_pass) {
        if (strlen($new_pass) > 5) {
            if ($new_pass == $con_pass) {
                ...
                $query2 = "UPDATE students SET `password`='$save_pass' WHERE username='$username'";
                $query_run2 = mysqli_query($conn, $query2);
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12" style="padding-bottom:30px;">
                    <h2 style="font-weight:600">Student Profile</h2>
                    <p><a href="student_home.php">Home</a> / Student Profile</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-5 thumb">
                    <img src="assets/img/students/<?php echo $image?>" alt="Thumb" width="90%">

        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12" style="padding-bottom:30px;">
                    ...
                    <p><a href="teacher_home.php">Home</a> / Teacher Home</p>
                </div>
            </div>
            <div class="row " style="">
                <div class="col-md-3">
                    <div class="card mx-auto"
                        ...
                        <h5 class="card-title" style="font-family:poppins;color:black;font-size:20px">Courses
                        </h5>
                    ...
                    <div class="card mx-auto"
                        ...
                        $total=0;
                                    ...
                                    if($result){
                                        ...
                                        $total= $total+$row_cnt1 ;
                                        }
                                      ?>
                            <h1 style="font-family:poppins;color:black;"><?php echo $total?></h1>
                            <?php
                ...
                <div class="col-md-3">
                    <div class="card mx-auto"
                        style="text-align:center;padding:30px 0px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); ">
                        <h5 class="card-title" style="font-family:poppins;color:black;font-size:20px">Exams Due</h5>
                        <div class="card-body" style="text-align:center; font-size:18px;">
                            <?php
                        $total=0;
                                    ...
                                    if($result){
                                        ...
                                        $sql1 = "SELECT * from course_exams where course_id = $course_id";
                                        $result1 = mysqli_query($conn, $sql1);
                                        $row_cnt2 = $result1->num_rows;
                                        $total= $total+$row_cnt2 ;
                ...
                <div class="col-md-3">
                    <div class="card mx-auto"
                        ...
                        <div class="card-body" style="text-align:center; font-size:18px;">
                            <?php
                                    $sql = "SELECT * from posts where sender_id ='$teacher_id' AND role = 'Teacher'";
                                    $result = mysqli_query($conn, $sql);
                                    $row_cnt = $result->num_rows;
                                ?>
                            <h1 style="font-family:poppins;color:black;"><?php echo $row_cnt?></h1>
            ...
            <div class="popular-courses without-carousel" style="margin-top:40px">
                <h2 style="font-weight:600;margin: 50px 0;">Latest Courses</h2>
